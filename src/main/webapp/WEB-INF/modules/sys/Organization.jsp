...
<head>
    ...
    <%-- 当前页面的CSS、JS脚本 --%>
    <link rel="stylesheet" type="text/css" href="${applicationScope.modulesPath}/sys/Organization.css">
    <script type="text/javascript" src="${applicationScope.modulesPath}/sys/Organization.js"></script>
    <%-- 页面标题 --%>
    <title>组织机构管理</title>
</head>
<body>
