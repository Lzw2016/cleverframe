...
<head>
    ...
    <%-- 当前页面的CSS、JS脚本 --%>
    <link rel="stylesheet" type="text/css" href="${applicationScope.modulesPath}/quartz/JobDetailLog.css">
    <script type="text/javascript" src="${applicationScope.modulesPath}/quartz/JobDetailLog.js"></script>
    <title>定时任务(JobDetail)日志</title>
</head>
<body class="easyui-layout" data-options="fit:true,border:false">
<%-- 页面上部 --%>
<div data-options="region:'north',border:true,minWidth:800" style="height:165px;">
...
<div id="centerPanel" data-options="region:'center',border:false">
    <table id="jobDetailLogDataTable" data-options="border:false">
        <thead>
        <tr>
            ...
            <th data-options="width:70 ,align:'left',hidden:false ,field:'isVeto',formatter:pageJsObject.isVetoFormatter">被否决</th>
            ...
            <th data-options="width:60,align:'left',hidden:false,field:'exceptionInfo',formatter:pageJsObject.exceptionInfoFormatter">出现异常</th>
        </thead>
    </table>
    <div id="jobDetailLogDataTableButtons">
        <a id="jobDetailLogDataTableButtonsSearch" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true">查询</a>
    </div>
</div>
