...
<head>
    ...
    <%-- 当前页面的CSS、JS脚本 --%>
    <link rel="stylesheet" type="text/css" href="${applicationScope.modulesPath}/core/CoreMain.css">
    <script type="text/javascript" src="${applicationScope.modulesPath}/core/CoreMain.js"></script>
    <%-- 页面标题 --%>
    <title>Core模块管理</title>
</head>
<body id="mainPanel" class="easyui-layout">
<!-- 页面上部 -->
<div data-options="region:'north',border:false">
    <div class="tabs-header" style="overflow: hidden; height: 50px;">
        <div class="logo">CleverFrame-Core</div>
        <div class="topNav">
