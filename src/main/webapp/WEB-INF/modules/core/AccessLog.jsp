    ...
    <form id="searchForm" method="post">
        <div class="row">
            ...
            <span class="columnLast">
                ...
                <input id="searchRequestStartTime" name="requestStartTime" class="easyui-textbox">
                <label for="searchRequestEndTime" style="text-align: center"> 至 </label>
                <input id="searchRequestEndTime" name="requestEndTime" class="easyui-textbox">
            </span>
        </div>
        ...
        <div class="row">
            <span class="column">
                ...
                <input id="searchMethod" name="method" class="easyui-textbox">
            </span>
        ...
        <div class="row">
            ...
            <span class="columnLast">
                ...
                <input id="searchProcessMinTime" name="processMinTime" class="easyui-textbox">
                <label for="searchProcessMaxTime" style="text-align: center">至</label>
                <input id="searchProcessMaxTime" name="processMaxTime" class="easyui-textbox">
            </span>
        </div>
        ...
        <div class="row">
            ...
            <span class="columnLast">
                ...
                <input id="searchHasException" name="hasException" class="easyui-textbox">
            </span>
        </div>
    </form>
</div>
...
<div id="centerPanel" data-options="region:'center',border:false">
    <table id="dataTable" data-options="border:false">
        ...
        <tr>
            ...
            <th data-options="width:150,align:'left',hidden:false,field:'loginName'">登录名</th>
            <th data-options="width:150,align:'left',hidden:false,field:'requestTime'">请求时间</th>
            <th data-options="width:150,align:'left',hidden:false,field:'requestUri'">请求URI</th>
            <th data-options="width:150,align:'left',hidden:false,field:'method'">操作方式</th>
            <th data-options="width:150,align:'left',hidden:false,field:'params'">操作提交的数据</th>
            <th data-options="width:150,align:'left',hidden:false,field:'processTime'">请求处理时间</th>
            <th data-options="width:150,align:'left',hidden:false,field:'remoteAddr'">请求IP</th>
            <th data-options="width:150,align:'left',hidden:false,field:'userAgent'">用户代理</th>
            <th data-options="width:150,align:'left',hidden:false,field:'hasException'">是否有异常</th>
            <th data-options="width:150,align:'left',hidden:false,field:'exceptionInfo'">异常信息</th>
        </tr>
        </thead>
    </table>
