...
<head>
    ...
    <%-- 当前页面的CSS、JS脚本 --%>
    <link rel="stylesheet" type="text/css" href="${applicationScope.modulesPath}/generator/GeneratorCode.css">
    <script type="text/javascript" src="${applicationScope.modulesPath}/generator/GeneratorCode.js"></script>
    <%-- 页面标题 --%>
    <title>代码生成器</title>
</head>
