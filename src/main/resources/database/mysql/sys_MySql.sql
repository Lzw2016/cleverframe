...
(
    ...
    resources_url       varchar(255)    NOT NULL                            COMMENT '资源URL地址',
    controller_method   varchar(255)    NOT NULL    UNIQUE                  COMMENT 'Spring Controller类对应的方法',
...
/*------------------------------------------------------------------------------------------------------------------------
TODO 增加字段 xss_filter 开启XSS过滤器(防止跨站脚本攻击)
--------------------------------------------------------------------------------------------------------------------------*/
