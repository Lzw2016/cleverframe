...
(
    ...
    category_name   varchar(100)    NOT NULL                            COMMENT '菜单类别名称',
    name            varchar(50)     NOT NULL                            COMMENT '菜单名称',
    resources_id    bigint                                              COMMENT '资源ID,关联表:core_resources',
...
(
    role_id         bigint          NOT NULL                            COMMENT '角色编号',
    resources_id    bigint          NOT NULL                            COMMENT '资源ID,关联表:core_resources',
...
/* ====================================================================================================================
    core_resources_relation -- 系统资源关系表
==================================================================================================================== */
CREATE TABLE core_resources_relation
(
